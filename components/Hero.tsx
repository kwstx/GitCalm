            ...
            <div className="hero-cards-container">
                ...
                <div className="hero-card hero-card-main">
                    <div className="hero-icon-container-lg" style={{ color: '#ef4444' }}>
                        {/* GitHub Logo */}
                        <svg className="hero-icon-svg-lg" viewBox="0 0 24 24" fill="currentColor" style={{ filter: 'drop-shadow(4px 8px 4px rgba(239, 68, 68, 0.4))' }}>
                ...
                {/* Left Inner Card */}
                <div className="hero-card hero-card-inner-left">
                ...
                {/* Right Inner Card */}
                <div className="hero-card hero-card-inner-right">
                ...
                {/* Left Outer Card */}
                <div className="hero-card hero-card-outer-left">
                ...
                {/* Right Outer Card */}
                <div className="hero-card hero-card-outer-right">
